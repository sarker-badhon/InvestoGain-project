...
//                             </label>
//                             <input type="text" placeholder="20%" className="input input-ghost border border-white w-full max-w-xs mt-3 " />
//                         </div>
//                         <div>
//                             <label htmlFor="jell" className='text-white'>  Minimum Investment
//                             </label>
//                             <input type="text" placeholder="$1500" className="input input-ghost border border-white w-full max-w-xs mt-3 " />
//                         </div>
//                         <div>
//                             <label htmlFor="jell" className='text-white'> Maximum Investment
//                             </label>
//                             <input type="text" placeholder="$30000" className="input input-ghost border border-white w-full max-w-xs mt-3 " />
//                         </div>
//                         <div>
//                             <label htmlFor="jell" className='text-white'> Investment
//                             </label>
//                             <input type="text" placeholder="$100000" className="input input-ghost border border-white w-full max-w-xs mt-3 " />
//                         </div>
//                         <div>
//                             <label htmlFor="jell" className='text-white'> Interest
//                             </label>
//                             <input type="text" placeholder="$750" className="input input-ghost border border-white w-full max-w-xs mt-3 " />
//                         </div>
//                         <div>
//                             <label htmlFor="jell" className='text-white'> Profit
//                             </label>
//                             <input type="text" placeholder="$590" className="input input-ghost border border-white w-full max-w-xs mt-3 " />
//                         </div>
//                         <div>
//                             <label htmlFor="jell" className='text-white'> Total Return
//                             </label>
//                             <input type="text" placeholder="$25000" className="input input-ghost border border-white w-full max-w-xs mt-3 " />
//                         </div>
