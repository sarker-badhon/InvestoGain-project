...
// const Navbar = () => {
//     return (
//         <div className='h-screen' style={{ backgroundImage: "url('https://i.ibb.co/VggPtPN/hero-bg.png')" }}>
...
//                                     <ul className="dropdown-content absolute hidden group-hover:block mt-6 py-4 text-white  bg-[#e98c5d] z-[5]  shadow-lg rounded-md w-52 ">
//                                         <li className='hover:bg-[#e98c5d]  '><a className='hover:text-white'>Dashboard</a></li>
//                                         <li className='hover:bg-[#e98c5d] '><a className='hover:text-white'>Blog Post</a></li>
//                                         <li className='hover:bg-[#e98c5d] '><a className='hover:text-white'>Blog Details</a></li>
//                                         <li className='hover:bg-[#e98c5d] '><a className='hover:text-white'>Create Account</a></li>
//                                         <li className='hover:bg-[#e98c5d] '><a className='hover:text-white'>Privacy Policy</a></li>
//                                         <li className='hover:bg-[#e98c5d] '><a className='hover:text-white'>Investor</a></li>
//                                         <li className='hover:bg-[#e98c5d] '><a className='hover:text-white'>FAQ</a></li>
//                                     </ul>
//                                 </li>
//                                 <li className="group">
...
//                             </ul>
//                         </div>
//                         <a className="btn btn-ghost normal-case text-3xl font-bold text-white">InvestoGain</a>
//                     </div>
...
//                         <button className="text-white uppercase font-bold border-2 hover:bg-[#DE606B] border-[#DE606B] px-8 py-2 rounded-2xl mr-2">SignUp</button>
//                         <button style={{ backgroundImage: "linear-gradient(to right, #de5c70 0%, #e98c5d 51%, #de5c70 100%)" }} className="text-white uppercase font-bold px-8 py-2.5 rounded-2xl">Login</button>
//                     </div>
//                 </div>
